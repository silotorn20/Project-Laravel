    ...
    <div class="container-center">
        <div class="form-container">
            <div class="form-content">
                <form id="update-form" action="{{ route('Update', ['id_member' => $member->id_member]) }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div>
                                <label style="color:#545454; font-size: 18px;"><strong>ชื่อ</strong></label>
                                <input type="text" class="form-control" id="Firstname" name="Firstname"
                                    value="{{ $member->Firstname }}">
                            </div>
                            <div>
                                <label style="color:#545454; font-size: 18px;"><strong>สกุล</strong></label>
                                <input type="text" class="form-control" id="LastName" name="LastName"
                                    value="{{ $member->LastName }}">
                            </div>
                            <div>
                                <label style="color:#545454; font-size: 18px;"><strong>อีเมล</strong></label>
                            ...
                            <div>
                                <label style="color:#545454; font-size: 18px;"><strong>รหัสผ่าน</strong></label>
                                <input type="password" name="password" class="form-control" id="password"
                                    placeholder="กรอกรหัสผ่านใหม่">
                                @if ($errors->has('password'))
                                <div class="text-danger">
                                    {{ "กรุณากรอกรหัสผ่านให้ครบ 8 ตัหว" }}
                                </div>
                                @endif
                            </div>
                            <div>
                                <label style="color:#545454; font-size: 18px;"><strong>เบอร์โทร</strong></label>
                                <input type="text" class="form-control @error('Phone') is-invalid @enderror" id="Phone"
                                    name="Phone" value="{{ $member->Phone }}" placeholder="เบอร์โทร">
                                @if ($errors->has('Phone'))
                                <div class="text-danger">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ url('/show') }}" class="btn" id="cancel-button"
